...
export const PLANS = {
  ...
  "marathon-beginner": {
    ...
    levelLabel: "初階",
    namePrefix: "漢森初階",
    xlsxFile: "templates/hanson-full-marathon-beginner-template.xlsx",
    xlsxName: "漢森初階全馬課表模板_互動版.xlsx",
    defaultGoal: "4:00",
    paceTable: PACE_TABLE,
  ...
  "half-beginner": {
    ...
    levelLabel: "初階",
    namePrefix: "漢森初階半馬",
    xlsxFile: "templates/hanson-half-marathon-beginner-template.xlsx",
    xlsxName: "漢森初階半馬課表模板_互動版.xlsx",
    defaultGoal: "1:45",
    paceTable: HALF_PACE_TABLE,
